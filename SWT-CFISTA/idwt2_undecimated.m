...
x = upsconv2_undecimated(a,{Lo_R,Lo_R},sx,dwtEXTM,shift)+ ... % Approximation.
    upsconv2_undecimated(h,{Hi_R,Lo_R},sx,dwtEXTM,shift)+ ... % Horizontal Detail.
    upsconv2_undecimated(v,{Lo_R,Hi_R},sx,dwtEXTM,shift)+ ... % Vertical Detail.
    upsconv2_undecimated(d,{Hi_R,Hi_R},sx,dwtEXTM,shift);     % Diagonal Detail.
